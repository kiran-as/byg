...
$editgroundsql = mysql_query("Select * from tbl_sport where idsport='$idsport'");
...
if($_POST)
{
    ...
    mysql_query("Update tbl_sport set sportname='$sportname' where idsport='$idsport'");
...
<form action='' method='POST'>	
                ...
                <div class="form-horizontal col-sm-6" >
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="type" class="form-control" name='sportname' id='sportname' value='<?php echo $sportname;?>'>
                    </div>
                  </div>
