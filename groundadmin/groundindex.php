...
$groundindexsql = mysql_query("Select * from tbl_ground where status='Active' and groundadmin='$idgroundadmin'");
$i=0;
  ...
  <body>
    ...
    <div class="row">
      <div class="form-group">        
        ...
        <div class="col-sm-4 txtr col-sm-offset-4" style='display:none'>
            <button type="button" class="btn btn-primary mar-b5" onclick='fnaddground()';></button>
        </div>
      </div>               
    </div>    
...
?>
		   ...
		   <td><?php  echo $groundarray[$i]['endtime'];?></td>
		    <td><a href="addcalendartoground.php?idground=<?php echo $groundarray[$i]['idground'];?>" class="add-price">Add Price</a></td>
