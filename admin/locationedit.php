...
$editgroundsql = mysql_query("Select * from tbl_location where idlocation='$idlocation'");
...
if($_POST)
{
    ...
    mysql_query("Update tbl_location set locationname='$locationname'
...
<form action='' method='POST'>	
                ...
                <div class="form-horizontal col-sm-6" >
                  <div class="form-group">
                    <label class="col-sm-4 control-label"><span class="error-text">*</span>Location</label>
                    <div class="col-sm-8">
                      <input type="type" class="form-control" name='locationname' id='locationname' value='<?php echo $locationname;?>'>
                    </div>
                  </div>
