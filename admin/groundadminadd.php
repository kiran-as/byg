...
if($_POST)
{
	...
	mysql_query("Insert into tbl_groundadmin (email,password,username,status) values 
...
<form action='' method='POST'>	
                ...
                <div class="form-horizontal col-sm-6" >
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="type" class="form-control" name='username' id='username'>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="type" class="form-control"  name='password' id='password'>                    
                    </div>
                  </div>   
